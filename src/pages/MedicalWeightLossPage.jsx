...
export function MedicalWeightLossPage() {
  return <Layout><main className="service-page">
    ...
    <section className="weight-final-cta"><p className="eyebrow">Start with clarity</p><h2>Let us match you to the right first visit.</h2><SiteLink className="button button-primary" to="/book?service=medical-weight-loss">Book a free consultation</SiteLink></section>
  </main></Layout>;
}
