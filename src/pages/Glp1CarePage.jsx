...
export function Glp1CarePage() {
  return <Layout><main className="service-page glp-page">
    <section className="service-hero service-hero-glp"><img src={asset("generated/glp1-training.webp")} alt="Clinician demonstrating a GLP-1 injection pen" /><div><p className="eyebrow">GLP-1 medication + nutrition support</p><h1>Know what to do before, during, and between doses.</h1><p>Starting semaglutide, tirzepatide, liraglutide, or another GLP-1 therapy can raise practical questions. NutriAll connects medical oversight with everyday nutrition and side-effect planning.</p><SiteLink className="button button-primary" to="/book?service=glp1">Book a free consultation</SiteLink></div></section>
    ...
    <section className="weight-final-cta"><p className="eyebrow">Considering or already taking a GLP-1?</p><h2>Build the support plan around it.</h2><SiteLink className="button button-primary" to="/book?service=glp1">Book a free consultation</SiteLink></section>
  </main></Layout>;
}
