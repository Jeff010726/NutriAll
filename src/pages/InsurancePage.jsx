...
export function InsurancePage() {
  return <Layout footerProps={{ note: "Coverage and expected cost are verified separately for medical visits, nutrition counseling, testing, and medication." }}><main className="insurance-page">
    ...
    <section className="info-band"><h2>Let us check before you book care.</h2><p>Request a free 15-minute call and share your insurance details if you want us to begin verifying benefits.</p><SiteLink className="button button-primary" to="/book?service=insurance">Check my benefits</SiteLink></section>
  </main></Layout>;
}
