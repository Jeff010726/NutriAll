...
export function RecipeDetailPage() {
  ...
  return <Layout title={`${recipe.title} | NutriAll`} footerProps={{ note: "Educational nutrition content from the NutriAll care team." }}><main className="recipe-detail-page">
