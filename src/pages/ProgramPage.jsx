...
export function ProgramPage() {
  return <Layout><main className="program-page">
    <section className="page-full-hero program-full-hero"><div><p className="eyebrow">Program</p><h1>A structured diabetes nutrition program that adapts to the person.</h1><p>From assessment to follow-up, the goal is to make blood sugar decisions clearer without flattening your culture, schedule, or preferences.</p></div></section>
    ...
    <section className="info-band"><h2>Ready to start?</h2><p>Begin with a free call so the team can confirm fit, insurance, and next steps.</p><SiteLink className="button button-primary" to="/book">Book now</SiteLink></section>
  </main></Layout>;
}
